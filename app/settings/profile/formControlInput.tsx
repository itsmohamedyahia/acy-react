  ...
  if (type === "select") {
    return (
      <select
        name={id}
        title={"select " + id}
        // className="block w-full p-2 mt-1 text-sm text-gray-900 FormControlInput rounded-lgfocus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
